...
from icarus.results import plot_lines2, plot_bar_chart
from icarus.registry import RESULTS_READER


# Logger object
logger = logging.getLogger('plot2')
...
def plot_cache_hits_vs_alpha(resultset, topology, cache_size, alpha_range, strategies, plotdir):
    ...
    plot_lines2(resultset, desc, 'CACHE_HIT_RATIO_T=%s@C=%s.jpg'
...
def plot_cache_hits_vs_cache_size(resultset, topology, alpha, cache_size_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines2(resultset, desc,'CACHE_HIT_RATIO_T=%s@A=%s.jpg'
...
def plot_link_load_vs_alpha(resultset, topology, cache_size, alpha_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines2(resultset, desc, 'LINK_LOAD_INTERNAL_T=%s@C=%s.jpg'
               % (topology, cache_size), plotdir)
...
def plot_link_load_vs_cache_size(resultset, topology, alpha, cache_size_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines2(resultset, desc, 'LINK_LOAD_INTERNAL_T=%s@A=%s.jpg'
               % (topology, alpha), plotdir)
...
def plot_latency_vs_alpha(resultset, topology, cache_size, alpha_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines2(resultset, desc, 'LATENCY + LINK LOAD + CACHE HIT RATIO_T=%s@C=%s.jpg'
               % (topology, cache_size), plotdir)
...
def plot_latency_vs_cache_size(resultset, topology, alpha, cache_size_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines2(resultset, desc, 'LATENCY_T=%s@A=%s.jpg'
               % (topology, alpha), plotdir)
...
def plot_cache_hits_vs_topology(resultset, alpha, cache_size, topology_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_bar_chart(resultset, desc, 'CACHE_HIT_RATIO_A=%s_C=%s.jpg'
...
def plot_link_load_vs_topology(resultset, alpha, cache_size, topology_range, strategies, plotdir):
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_bar_chart(resultset, desc, 'LINK_LOAD_INTERNAL_A=%s_C=%s.jpg'
                   % (alpha, cache_size), plotdir)




def plot_sum_of_all(resultset, alpha_range, cache_size, topology, strategies, plotdir):
    desc = {}
    desc['title'] = 'Latency: T=%s C=%s' % (topology, cache_size)
    desc['xlabel'] = u'Content distribution \u03b1'
    desc['ylabel'] = 'Latency (ms) + Internal link load + Cache hit ratio'
    desc['xparam'] = ('workload', 'alpha')
    desc['xvals'] = alpha_range
    desc['filter'] = {'topology': {'name': topology},
                      'cache_placement': {'network_cache': cache_size}}
    desc['ymetrics'] = [('LATENCY'+ 'LINK_LOAD'+ 'CACHE_HIT_RATIO' , 'MEAN')]*len(strategies)
    desc['ycondnames'] = [('strategy', 'name')]*len(strategies)
    desc['ycondvals'] = strategies
    desc['errorbar'] = True
    desc['legend_loc'] = 'upper right'
    ...
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines(resultset, desc, 'LATENCY_T=%s@C=%s.jpg'
               % (topology, cache_size), plotdir)
...
def plot_sum_of_all(resultset, alpha_range, cache_size, topology, strategies, plotdir):
    ...
    desc['filter'] = {'topology': {'name': topology},
                      'cache_placement': {'network_cache': cache_size}}
    tuple_1 = ('LATENCY', 'MEAN')
    tuple_2 = ('LINK_LOAD', 'MEAN_INTERNAL')
    tuple_3 = ('CACHE_HIT_RATIO', 'MEAN')
    #sum_array = [sum(x) for x in zip(tuple_1,tuple_2,tuple_3)]
    #desc['ymetrics'] = sum_array*len(strategies)
    desc['ymetrics'] = [('LATENCY' , 'MEAN')]*len(strategies)
    desc['ycondnames'] = [('strategy', 'name')]*len(strategies)
    desc['ycondvals'] = strategies
    #print(desc['ymetrics'], desc['ycondnames'], desc['ycondvals'])
    desc['errorbar'] = True
    desc['legend_loc'] = 'upper right'
    desc['line_style'] = STRATEGY_STYLE
    desc['legend'] = STRATEGY_LEGEND
    desc['plotempty'] = PLOT_EMPTY_GRAPHS
    plot_lines2(resultset, desc, 'LATENCY_T=%s@C=%s.jpg'
               % (topology, cache_size), plotdir)
...
#            plot_sum_of_all(resultset, topology, alpha, cache_sizes, strategies, plotdir)
